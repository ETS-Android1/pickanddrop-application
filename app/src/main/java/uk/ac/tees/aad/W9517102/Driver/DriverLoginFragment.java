...
public class DriverLoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        registerTv.setOnClickListener(view1 -> DashboardActivity.fragmentManager.beginTransaction().replace(R.id.container, new DriverRegisterFragment(), null).commit());
        ...
        fingerPrintIv.setOnClickListener(view12 -> {
            ...
            public void onClick(View view) {
                forgotPasswordTv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        args.putString("userType", "driver");
    ...
    private void FingerPrint() {
        if (new SharedPreference(getContext()).getLastUserType().equals("driver")) {
         ...
         userRef.child(mUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.hasChild("userType")) {
                    if (snapshot.child("userType").getValue().toString().equals("driver")) {
                        progressDialog.dismiss();
                        ...
                        btnLogin.setEnabled(true);
                        progressDialog.dismiss();
                        Toast.makeText(getContext(), "This is not Driver email", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    btnLogin.setEnabled(true);
                    progressDialog.dismiss();
