...
import uk.ac.tees.aad.W9517102.Driver.DriverHomeActivity;
...
public class CustomerRegisterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loginTv.setOnClickListener(view1 -> DashboardActivity.fragmentManager.beginTransaction().replace(R.id.container, new CustomerLoginFragment(), null).commit());
